...
export type Theme = {
  ...
  /**
   * Default card background opacity for this theme (0.30–1.0).
   * Applied automatically on theme switch unless the user has manually set their own value.
   */
  defaultCardOpacity?: number;
};
