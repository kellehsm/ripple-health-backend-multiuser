...
const cozyCat: Theme = {
  ...
  iconOverrides: {
    ...
    "greeting.evening":   { type: "image", source: require("../../assets/themes/cat/meal_lunch.png"), scale: 1.35 },
    ...
    "screen.mindfulness": { type: "image", source: require("../../assets/themes/cat/meal_dinner.png"), scale: 1.35 },
