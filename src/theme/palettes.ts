...
const cozyCat: Theme = {
  ...
  iconOverrides: {
    "greeting.morning":   { type: "image", source: require("../../assets/themes/cat/greeting_morning.png"), scale: 1.35 },
    "greeting.afternoon": { type: "image", source: require("../../assets/themes/cat/greeting_afternoon.png"), scale: 1.35 },
    "greeting.evening":   { type: "image", source: require("../../assets/themes/cat/greeting_evening.png"), scale: 1.35 },
    "mealType.breakfast": { type: "image", source: require("../../assets/themes/cat/meal_breakfast.png"), scale: 1.35 },
    "mealType.lunch":     { type: "image", source: require("../../assets/themes/cat/meal_lunch.png"), scale: 1.35 },
    "mealType.dinner":    { type: "image", source: require("../../assets/themes/cat/meal_dinner.png"), scale: 1.35 },
    "mealType.snack":     { type: "image", source: require("../../assets/themes/cat/snack.png"), scale: 1.35 },
    "tab.home":           { type: "image", source: require("../../assets/themes/cat/tab_home.png"), scale: 2.6 },
    "screen.mindfulness": { type: "image", source: require("../../assets/themes/cat/screen_mindfulness.png"), scale: 1.35 },
